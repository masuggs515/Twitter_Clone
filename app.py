...
def show_liked_messages(user_id):
    ...
    return render_template('messages/liked_messages.html', user=user, likes=likes)
...
def remove_like(msg_id):
    removed = Likes.query.filter_by(message_id=msg_id).filter_by(user_id=g.user.id).first()
